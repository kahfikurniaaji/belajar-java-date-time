...
public class YearTest {
    ...
    void create() {
        ...
        YearMonth yearMonth2 = YearMonth.of(2000, Month.SEPTEMBER);
        YearMonth yearMonth3 = YearMonth.parse("1966-08");
        ...
        MonthDay monthDay2 = MonthDay.of(Month.SEPTEMBER, 17);
        MonthDay monthDay3 = MonthDay.parse("--09-17");
    ...
    void name() {
        ...
        LocalDate localDate = year.atMonth(Month.SEPTEMBER).atDay(17);
